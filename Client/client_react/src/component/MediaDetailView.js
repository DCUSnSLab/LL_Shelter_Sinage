    ...
    return(
        ...
        <section id="section1" style={{marginTop: '69px'}}>
            <div class="container">
                ...
                <div id="div1">
                    <video id="picture" style={{height: '900px', width: '2000px', objectFit: 'cover'}}
                           autoplay controls loop muted poster="https://cdn.pixabay.com/photo/2020/05/30/17/57/flower-5239814_960_720.jpg" preload="auto">
                        <source src="/media/{{description_info.upload_file}}" type="video/mp4" />
                    </video>
                </div>
